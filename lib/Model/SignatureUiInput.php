...
class SignatureUiInput implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['default_zoom']) && ($this->container['default_zoom'] > 500)) {
            $invalidProperties[] = "invalid value for 'default_zoom', must be smaller than or equal to 500.";
        }

        if (!is_null($this->container['default_zoom']) && ($this->container['default_zoom'] < 1)) {
            $invalidProperties[] = "invalid value for 'default_zoom', must be bigger than or equal to 1.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['default_zoom'] > 500) {
            return false;
        }
        if ($this->container['default_zoom'] < 1) {
            return false;
        }
        return true;
    }
     ...
     * Sets default_zoom
     *
     * @param float $default_zoom Default value for zoom of the PDF viewer. Default value is the adapted to the resolution of your screen.
     *
     * @return $this
     */
    public function setDefaultZoom($default_zoom)
    {
        ...
        if (!is_null($default_zoom) && ($default_zoom > 500)) {
            throw new \InvalidArgumentException('invalid value for $default_zoom when calling SignatureUiInput., must be smaller than or equal to 500.');
        }
        if (!is_null($default_zoom) && ($default_zoom < 1)) {
            throw new \InvalidArgumentException('invalid value for $default_zoom when calling SignatureUiInput., must be bigger than or equal to 1.');
        }
