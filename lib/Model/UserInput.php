...
class UserInput implements ModelInterface, ArrayAccess
{
    ...
    public function setCompany($company)
    {
        ...
        if ((!preg_match("/^\/companies\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/", $company))) {
            throw new \InvalidArgumentException("invalid value for $company when calling UserInput., must conform to the pattern /^\/companies\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/.");
        }
    ...
    public function setGroup($group)
    {
        ...
        if (!is_null($group) && (!preg_match("/^\/user_groups\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/", $group))) {
            throw new \InvalidArgumentException("invalid value for $group when calling UserInput., must conform to the pattern /^\/user_groups\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/.");
        }
    ...
    public function setDefaultSignImage($default_sign_image)
    {
        ...
        if (!is_null($default_sign_image) && (!preg_match("/^\/files\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/", $default_sign_image))) {
            throw new \InvalidArgumentException("invalid value for $default_sign_image when calling UserInput., must conform to the pattern /^\/files\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/.");
        }
