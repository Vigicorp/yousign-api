...
class FileOutput implements ModelInterface, ArrayAccess
{
    ...
    public function setCompany($company)
    {
        ...
        if (!is_null($company) && (!preg_match("/^\/companies\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/", $company))) {
            throw new \InvalidArgumentException("invalid value for $company when calling FileOutput., must conform to the pattern /^\/companies\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/.");
        }
    ...
    public function setCreator($creator)
    {
        ...
        if (!is_null($creator) && (!preg_match("/^\/users\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/", $creator))) {
            throw new \InvalidArgumentException("invalid value for $creator when calling FileOutput., must conform to the pattern /^\/users\/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/.");
        }
