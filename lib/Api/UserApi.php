...
class UserApi
{
    ...
    {
        list($response) = $this->usersIdPutWithHttpInfo($id, $content_type, $authorization, $body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersIdPutAsync($id, $content_type, $authorization, $body)
    {
        return $this->usersIdPutAsyncWithHttpInfo($id, $content_type, $authorization, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function usersIdPutRequest($id, $content_type, $authorization, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->usersPostWithHttpInfo($content_type, $authorization, $body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersPostAsync($content_type, $authorization, $body)
    {
        return $this->usersPostAsyncWithHttpInfo($content_type, $authorization, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function usersPostRequest($content_type, $authorization, $body)
    {
        // verify the required parameter 'content_type' is set
        if ($content_type === null) {
            throw new \InvalidArgumentException(
