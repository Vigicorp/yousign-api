...
class ProceduresApi
{
    ...
    protected function exportProceduresGetRequest($authorization, $status = null, $name = null, $members_firstname = null, $members_lastname = null, $members_phone = null, $members_email = null, $files_name = null, $created_at = null, $updated_at = null, $expires_at = null, $deleted_at = null, $order = null)
    {
        ...
        if (is_array($created_at)) {
            $created_at = ObjectSerializer::serializeCollection($created_at, 'csv', true);
        }
        if ($created_at !== null) {
        ...
        if (is_array($updated_at)) {
            $updated_at = ObjectSerializer::serializeCollection($updated_at, 'csv', true);
        }
        if ($updated_at !== null) {
        ...
        if (is_array($expires_at)) {
            $expires_at = ObjectSerializer::serializeCollection($expires_at, 'csv', true);
        }
        if ($expires_at !== null) {
        ...
        if (is_array($deleted_at)) {
            $deleted_at = ObjectSerializer::serializeCollection($deleted_at, 'csv', true);
        }
        if ($deleted_at !== null) {
        ...
        // query params
        if (is_array($order)) {
            $order = ObjectSerializer::serializeCollection($order, 'csv', true);
        }
        if ($order !== null) {
     ...
     * @param  string $authorization Authentication credentials for HTTP authentication (required)
     * @param  string $status Return Procedure list based on the status for each Procedure (optional)
     * @param  bool $template Used to get Procedure template list (optional, default to false)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function proceduresGetAsync($authorization, $status = null, $template = 'false', $members = null, $items_per_page = null, $pagination = null, $page = null, $name = null, $members_firstname = null, $members_lastname = null, $members_phone = null, $members_email = null, $files_name = null, $created_at = null, $updated_at = null, $expires_at = null, $deleted_at = null, $order = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proceduresGetRequest($authorization, $status = null, $template = 'false', $members = null, $items_per_page = null, $pagination = null, $page = null, $name = null, $members_firstname = null, $members_lastname = null, $members_phone = null, $members_email = null, $files_name = null, $created_at = null, $updated_at = null, $expires_at = null, $deleted_at = null, $order = null)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if (is_array($members)) {
            $members = ObjectSerializer::serializeCollection($members, 'csv', true);
        }
        if ($members !== null) {
    ...
    {
        list($response) = $this->proceduresIdDuplicatePostWithHttpInfo($id, $authorization, $body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function proceduresIdDuplicatePostAsync($id, $authorization, $body)
    {
        return $this->proceduresIdDuplicatePostAsyncWithHttpInfo($id, $authorization, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proceduresIdDuplicatePostRequest($id, $authorization, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->proceduresIdPutWithHttpInfo($id, $content_type, $authorization, $body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function proceduresIdPutAsync($id, $content_type, $authorization, $body)
    {
        return $this->proceduresIdPutAsyncWithHttpInfo($id, $content_type, $authorization, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proceduresIdPutRequest($id, $content_type, $authorization, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->proceduresIdRemindPostWithHttpInfo($id, $authorization, $body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function proceduresIdRemindPostAsync($id, $authorization, $body)
    {
        return $this->proceduresIdRemindPostAsyncWithHttpInfo($id, $authorization, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proceduresIdRemindPostRequest($id, $authorization, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->proceduresPostWithHttpInfo($content_type, $authorization, $body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function proceduresPostAsync($content_type, $authorization, $body)
    {
        return $this->proceduresPostAsyncWithHttpInfo($content_type, $authorization, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proceduresPostRequest($content_type, $authorization, $body)
    {
        // verify the required parameter 'content_type' is set
        if ($content_type === null) {
            throw new \InvalidArgumentException(
